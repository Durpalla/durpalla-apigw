            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="card-body">
                            ...
                            <select name="merchant_id" class="form-control @error('merchant_id') is-invalid @enderror"
                                ...
                                @foreach( $merchant_dropdowns as $key => $value )
                                    <option value="{{ old('merchant_id', $key) }}"
                                            @if(old('merchant_id', $vehicle->merchant_id) == $key) selected @endif>{{ $value }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            <label>Route</label> <a href="{{ route('dashboard.routes.create') }}" data-toggle="modal"
                                                    data-target="#routeModal"><i class="fas fa-plus"></i> add new</a>
                            <select name="route_id" class="form-control @error('route_id') is-invalid @enderror"
                                    value="{{ old('route_id') }}" required>
                                @if( !$vehicle->routeMap )
                                    <option value="">Select route</option>
                                @endif
                                @foreach( $route_dropdowns as $key => $value )
                                    <option value="{{ $key }}"
                                            @if(old('route_id', $vehicle->route_id) == $key) selected @endif>{{ $value }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                   placeholder="vehicle name" value="{{ old('name', $vehicle->name) }}" required>
                            @error('name')
                            <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="registration_expiry_date"
                                       value="{{ old('registration_expiry_date', date('d/m/Y', strtotime( $vehicle->registration_expiry_date ) ) ) }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="fitness_expiry_date"
                                       value="{{ old('fitness_expiry_date', date('d/m/Y', strtotime( $vehicle->fitness_expiry_date) ) ) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="0" max="5000" name="passengers_capacity"
                                   ...
                                   value="{{ old('passengers_capacity', $vehicle->passengers_capacity) }}" required>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="number_of_floor">
                                @for($i = 1; $i <= 10; $i++)
                                <option value="{{ $i }}" @if(old('number_of_floor', $vehicle->number_of_floor) === $i) selected @endif>{{ $i }}</option>
                                @endfor
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="default_floor">
                                @for($i = 1; $i <= 10; $i++)
                                    <option value="{{ $i }}" @if(old('default_floor', $vehicle->default_floor) === $i) selected @endif>{{ $i }}</option>
                                @endfor
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="default_tab">
                                <option value="cabin" @if(old('default_tab', $vehicle->default_tab) == 'cabin') selected @endif>Cabin</option>
                                <option value="seat" @if(old('default_tab', $vehicle->default_tab) == 'seat') selected @endif>Seat</option>
                                <option value="deck" @if(old('default_tab', $vehicle->default_tab) == 'deck') selected @endif>Deck</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>AC Available?</label>
                            <select class="form-control" name="ac_available">
                                <option value="0" @if($vehicle->ac_available === 0) selected @endif>No</option>
                                <option value="1" @if($vehicle->ac_available === 1) selected @endif>Yes</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>NID Verification required?</label>
                            <select class="form-control" name="nid_verification_check">
                                <option value="0" @if(old('nid_verification_check', $vehicle->nid_verification_check) == 0) selected @endif>No</option>
                                <option value="1" @if(old('nid_verification_check', $vehicle->nid_verification_check) == 1) selected @endif>Yes</option>
                            </select>
                        </div>
                        <div class="form-group">
