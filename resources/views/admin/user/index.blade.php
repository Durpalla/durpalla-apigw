            ...
            <div class="card" style="background-color: none;">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            ...
                            <a href="{{ route('dashboard.user.create') }}" class="btn btn-xs btn-primary"><i class="fa fa-plus"></i> Add new</a>
                            @endcan
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <table class="table table-striped table-bordered projects display responsive nowrap" id="dataTable">
                        <thead>
                            <tr>
                                <th style="width:5%"><div><i class="fa fa-image"></i></div></th>
                                <th><div>Name</div></th>
                                <th><div>Email</div></th>
...
$(function(){
    ...
    var table = $('#dataTable').DataTable( {
      ...
      "columnDefs": [
      {"targets": [0,4,6], "searchable": false, "orderable": false, "visible": true}
      ],
      "order": [[1, 'asc']],
      buttons: [
    ...
    $('table').on('click', '.user-action', function(e) {
        ...
        if( action == 'request' ) {
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "You are going to " + action + " this user account.",
                icon: 'warning',
