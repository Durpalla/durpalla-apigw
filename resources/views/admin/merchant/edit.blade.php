        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form role="form" action="{{ route('dashboard.merchant.update', $merchant->id) }}" method="POST"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="merchant_address"
                                                       ...
                                                       value="{{ old('merchant_address', $merchant->merchant_address) }}">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="merchant_reg_no"
                                                       value="{{ old('merchant_reg_no', $merchant->merchant_reg_no) }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="merchant_reg_expiry_date"
                                                           value="{{ old('merchant_reg_expiry_date', date('d/m/Y', strtotime( $merchant->merchant_reg_expiry_date ) )) }}"
                                                           class="form-control datepicker @error('merchant_reg_expiry_date') is-invalid @enderror"
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" name="merchant_email"
                                                       ...
                                                       value="{{ old('merchant_email', $merchant->merchant_email) }}"
                                                       required>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="merchant_mobile"
                                                       value="{{ old('merchant_mobile', $merchant->merchant_mobile) }}"
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="merchant_phone"
                                                       value="{{ old('merchant_phone', $merchant->merchant_phone) }}"
                                  ...
                                  <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="merchant_fax"
                                                       value="{{ old('merchant_fax', $merchant->merchant_fax) }}"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="password" name="merchant_password"
                                                       value="{{ old('merchant_password') }}" autocomplete="off"
                            ...
                            <div class="col-sm-5 pr-4">
                                <div class="form-group">
                                    ...
                                    <select name="vat_visibility" id="vat_applicable_to" class="form-control" required>
                                        ...
                                        <option value="1"
                                                @if(old('vat_applicable_to', $merchant->vat_visibility) == '1' ) selected @endif>
                                            Yes
                                        </option>
                                        <option value="0"
                                                @if(old('vat_visibility', $merchant->vat_visibility) == '0' ) selected @endif>
                                            No
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="vat_applicable_to" id="vat_applicable_to" class="form-control"
                                        ...
                                        <option value="customer"
                                                @if(old('vat_applicable_to', $merchant->vat_applicable_to) == 'customer' ) selected @endif>
                                            Customer
                                        </option>
                                        <option value="merchant"
                                                @if(old('vat_applicable_to', $merchant->vat_applicable_to) == 'merchant' ) selected @endif>
                                            Merchant
                                        </option>
                                        <option value="vendor"
                                                @if(old('vat_applicable_to', $merchant->vat_applicable_to) == 'vendor' ) selected @endif>
                                            Vendor
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" id="inputPassword5" name="honorium_service_charge"
                                               value="{{ old('honorium_service_charge', getOption('honorium_service_charge', $merchant->honorium_service_charge))}}"
                    ...
                    <span class="input-group-text p-0">
                      <select class="form-control" name="honorium_type">
                          <option value="percent"
                                  @if(old('honorium_type', $merchant->honorium_type) == 'percent') selected @endif>Percent</option>
                          <option value="fixed" @if(old('honorium_type', $merchant->honorium_type) == 'fixed') selected @endif>Fixed</option>
                      </select>
                    </span>
                                        </div>
                                    </div>
                      ...
                      <span class="input-group-btn">
                          <span class="btn btn-default btn-file">
                              Browse… <input type="file" name="logo" id="imgInp">
                                    ...
                                    <img id='img-upload' src="{{ asset('images').'/'.$merchant->logo}}"/>
                                    <span
