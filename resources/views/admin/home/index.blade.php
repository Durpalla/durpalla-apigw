...
@section('content')
    ...
    <div class="row pt-2">
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3" data-type="other"
                 onclick="window.open('{{ route('dashboard.merchant.index') }}')">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{ $stats['total_merchants']}}</span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <!-- /.col -->
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box" onclick="window.open('{{ route('dashboard.vehicle.index') }}')">
...
<div class="col-12 col-sm-6 col-md-3">
  <div class="info-box mb-3">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-9">
                            <p class="text-center">
                                <strong>Period: <span
                                        id="chartPeriod">{{ date('01 M Y', strtotime($month)) }} - {{ date('t M Y', strtotime($month)) }}</span></strong>
                            </p>
                        ...
                        <div class="col-md-3">
                            <div id="priceQtyFiltering">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input item" type="radio" name="priceQty" id="price"
                                           value="price" checked>
                                    <label class="form-check-label" for="price">Price</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input item" type="radio" name="priceQty" id="quantity"
                                           value="quantity">
                                ...
                                <div class="progress-group" id="cabinGoal">
                                    ...
                                    <div class="progress progress-sm">
                                        <div class="progress-bar bg-primary"
                                             style="width: {{ ($stats['total_bookings'] > 0) ? round(($stats['total_cabin_booking_amount']*100)/$stats['total_booking_amount']) : 0 }}%"></div>
                                    </div>
                                </div>
                                ...
                                <div class="progress-group" id="seatGoal">
                                    ...
                                    <div class="progress progress-sm">
                                        <div class="progress-bar bg-danger"
                                             style="width: {{ ($stats['total_bookings'] > 0) ? round(($stats['total_seat_booking_amount']*100)/$stats['total_booking_amount']) : 0 }}%"></div>
                                    </div>
                                </div>
                                ...
                                <div class="progress-group" id="deckGoal">
                                    ...
                                    <div class="progress progress-sm">
                                        <div class="progress-bar bg-success"
                                             style="width: {{ ($stats['total_bookings'] > 0) ? round(($stats['total_deck_booking_amount']*100)/$stats['total_booking_amount']) : 0 }}%"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="goalQuantity" class="d-none">
                                <div class="progress-group" id="cabinGoal">
                                    ...
                                    <div class="progress progress-sm">
                                        <div class="progress-bar bg-primary"
                                             style="width: {{ ($stats['total_bookings'] > 0) ? round(($stats['total_cabin_bookings']*100)/$stats['total_bookings']) : 0 }}%"></div>
                                    </div>
                                </div>
                                ...
                                <div class="progress-group" id="seatGoal">
                                    ...
                                    <div class="progress progress-sm">
                                        <div class="progress-bar bg-danger"
                                             style="width: {{ ($stats['total_bookings'] > 0) ? round(($stats['total_seat_bookings']*100)/$stats['total_bookings']) : 0 }}%"></div>
                                    </div>
                                </div>
                                ...
                                <div class="progress-group" id="deckGoal">
                                    ...
                                    <div class="progress progress-sm">
                                        <div class="progress-bar bg-success"
                                             style="width: {{ ($stats['total_bookings'] > 0) ? round(($stats['total_deck_bookings']*100)/$stats['total_bookings']) : 0 }}%"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2 col-6">
                            <div class="description-block border-right">
                                ...
                                <h5 class="description-header">{{ $stats['total_vat_amount'] }} Tk.</h5>
                                <span class="description-text">VAT (Overall)</span>
                            </div>
                        </div>
                        <div class="col-sm-2 col-6">
                            <div class="description-block border-right">
                ...
                <div class="form-group">
                    <div class="input-group input-group-lg">
                        <input type="text" name="search_query" class="form-control"
                               placeholder="PNR / Booking ID / Mobile" required/>
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="schedule-tab" data-toggle="tab" href="#schedule" role="tab"
                               aria-controls="schedule" aria-selected="true">Current Schedules</a>
                        </li>
                        <li class="nav-item" role="presentation">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab"
                               aria-controls="contact" aria-selected="false">VAT</a>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent" style="height: 520px; overflow-y: auto;">
                        <div class="tab-pane fade show active" id="schedule" role="tabpanel"
                            ...
                            <table class="table m-0">
                                ...
                                <tbody>
                                @foreach($stats['currentTrips'] as $trip)
                                <tr>
                                    <td>{{ $trip->vehicle->name }}</td>
                                    <td>{{ $trip->vehicle->merchant->merchant_name }}</td>
                                    <td>
                                        @php
                                            $route = explode('-', $trip->route->route_name);
                                            $route_name = ($trip->schedule_type == 'reverse') ? trim($route[1]) . ' to ' . trim($route[0]) : $route[0] . '-' . $route[1];
                                        @endphp
                                        {{ $route_name }}
                                    </td>
                                    <td>Today at {{ date('h:i A', strtotime($trip->leaving_at)) }}</td>
                                    <td>
                                        <a href="{{ route('dashboard.schedule.show', $trip->id) }}" class="btn btn-default"><i class="fa fa-chart-bar"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                @if( $groupBookings )
                                    @foreach( $groupBookings as $key => $booking )
                                        <?php
                                        $date = date('d/m/Y', strtotime($key));
                                        $vat = collect($booking)->sum('vat');
                                        $totalVat = collect($booking)->sum('total') * (getOption('vat_amount') / 100);
                                        ?>
                                        <tr>
                                            <td>{{ $date }}</td>
                                            <td>{{ $vat }}</td>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body p-0">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="device-tab" data-toggle="tab" href="#device" role="tab"
                               aria-controls="device" aria-selected="true">Devices</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="location-tab" data-toggle="tab" href="#location" role="tab"
                               aria-controls="location" aria-selected="false">Locations</a>
                        </li>
                        <li class="nav-item" role="presentation">
    ...
    <div class="modal fade bd-example-modal-xl" data-backdrop="static" id="dashboardSearchModal" tabindex="-1"
