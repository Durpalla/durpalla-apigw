...
<section class="content content-overlap">
  <div class="row">
    <div class="col-12">
      ...
      <div class="col-md-7">
        <div class="card-body">
             <form method="post" action="{{ route('dashboard.blogcatagory.store')}}" role="form">
              @csrf
              <div class="form-group">
                <label>Title</label>
                <input type="text" class="form-control" name="title" placeholder="Catagory Title"/>
              </div>
             
              <div class="form-group">
                <label>Description</label>
                <textarea class="form-control bcontent" name="content_body"></textarea>
              </div>
              <div class="form-group">
