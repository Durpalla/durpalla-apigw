            ...
            <div class="card-header">
              ...
              <div class="card-tools">
                <div class="btn-group" role="group" aria-label="btn-group">
                  <a href="{{ route('dashboard.blogcatagory.index') }}" class="btn btn-xs btn-primary"><i class="fa fa-angle-left"></i> back</a>
                </div>
              </div>
            </div>
            <!-- /.card-header -->

            <form role="form" action="{{ route('dashboard.blogcatagory.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-7">
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        ...
                        <div class="form-group">
                          <label>Content</label>
                           <textarea class="form-control bcontent" class="form-control @error('content_body') is-invalid @enderror" name="content_body" required>{{ old('description', $blog->description) }}</textarea>
                          @error('content_body')
                              <span class="invalid-feedback" role="alert"> 
                                  <strong>{{ $message }}</strong>
                              </span>
                    ...
                    <div class="form-group">
                      <button type="submit" class="btn btn-lg btn-primary">Update Page Component</button>
                    </div>
                  </div>
                </div>
        </form>
