...
@section('content')
    ...
    <section class="content content-overlap">
        <form method="post" action="{{ route('dashboard.sponsor.update', $sponsor->id)}}" role="form" enctype="multipart/form-data"
              id="couponForm">
            @method('put')
            <div class="row">
                <!-- /.card-header -->
                <div class="col-md-7">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title" value="{{old('title', $sponsor->title)}}"
                                   class="form-control @error('title') is-invalid @enderror" placeholder="Sponsor title"
                                   required="">
                            @error('title')
