            ...
            <div class="col-12">
                ...
                <div class="col-md-7">
                    <div class="card-body">
                        ...
                        <form role="form" action="{{ route('dashboard.routes.update', $route->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select name="service_type" class="form-control @error('service_type') is-invalid @enderror" required>
                                            ...
                                            @foreach($service_list as $key => $value)
                                                <option value="{{ $key }}" @if(old('service_type', $route->service_type) == $key) selected @endif>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                        @error('service_type')
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="routeNameVal" name="route_name"
                                               ...
                                               value="{{ old('route_name', $route->route_name) }}" required readonly>
                                        @error('route_name')
                    ...
                    <strong>{{ $message }}</strong>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="route_no"
                                               value="{{ old('route_no', $route->route_no) }}"
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select name="route_type"
                                                class="form-control  @error('route_type', $route->route_type) is-invalid @enderror"
                                                required>
                    ...
                    <strong>{{ $message }}</strong>
                            ...
                            <div class="row">
                                <div class="col-sm-12" id="buildyourform">
                                    <div class="row fieldwrapper" id="field1">
                                        <div class="col-md-6 form-group">
                                            <div class="select2-purple">
                                                <select name="property_name[]" class="select2" id="starting"
                                                        ...
                                                        required>
                                                    <option value="{{ $route->startingPoint['ghat_id']}}"
                                                            selected>{{ $route->startingPoint['ghat']['name'] }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2 form-group">
                                            <input type="number" step="1" class="fieldname form-control"
                                                   name="property_position[]" min="1" max="1" value="1" required>
                                        </div>
                                    </div>
                                    <div class="row fieldwrapper" id="field2">
                                            ...
                                            <div class="form-group">
                                                <div class="select2-purple">
                                                    <select name="property_name[]" class="select2" id="ending"
                                                            ...
                                                            style="width: 100%;">
                                                        <option value="{{ $route->endingPoint['ghat_id']}}"
                                                                selected>{{ ($route->endingPoint['ghat'] != null) ? $route->endingPoint['ghat']['name'] : '' }}</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2 form-group">
                                            <input type="number" step="1" id="endingPointPosition" class="fieldname form-control"
                                                   name="property_position[]" min="2" max="20"
                                                   value="{{$route->endingPoint['serial_num']}}" required>
                                        </div>
                                    </div>
                                    @if( $route->boardingVias->count() > 0 )
                                        @foreach( $route->boardingVias as $key => $boarding )
                                            <div class="row fieldwrapper" id="field1">
                                                <div class="col-md-6 form-group">
                                                    <select name="property_name[]" class="select2" id="via{{ $key }}"
                                                            data-placeholder="Select ghat"
                                                            data-dropdown-css-class="select2-purple"
                                                            style="width: 100%;">
                                                        <option value="{{ $boarding['ghat_id']}} "
                                                                selected>{{ $boarding['ghat']['name'] }}</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-4 form-group">
                                                    <select class="fieldname form-control" name="property_type[]">
                                                        <option value="{{ $boarding->type }}">
                                                        @php
                                                            switch( $boarding->type ) {
                                                              case'start':
                                                                echo 'Starting point';
                                                                break;
                                                              case'end':
                                                ...
                                                <div class="col-md-2 form-group">
                                                    <input type="number" step="1" class="fieldname form-control"
                                                           name="property_position[]" min="2" max="20"
                                                           value="{{ $boarding->serial_num }}" required>
                                                </div>
                                            </div>
                                        @endforeach
                                    @endif
                            ...
                            <hr>
                            <div class="form-group">
                                <button type="submit" class="btn btn-lg btn-primary">Update route</button>
                            </div>
                        </form>
                    </div>
                </div>
