          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="card-tools">
                <div class="btn-group" role="group" aria-label="btn-group">
                  <a href="{{ route('dashboard.page.index') }}" class="btn btn-xs btn-primary"><i class="fa fa-angle-left"></i> back</a>
                </div>
              </div>
            </div>
            <!-- /.card-header -->

            <form role="form" action="{{ route('dashboard.page.update', $page->id) }}" method="POST" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-7">
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        ...
                        <div class="form-group">
                          <label>Title</label>
                          <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="Title" value="{{ old('title', $page->title) }}" required>
                          @error('title')
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" value="{{ old('slug', $page->slug) }}" class="form-control" name="slug" placeholder="Page slug"/>
                        </div>
                        @endif
                        <div class="form-group">
                          <label>Content</label>
                           <textarea class="form-control bcontent" id="summernote" name="body" class="form-control @error('body') is-invalid @enderror" required>{{ old('body', $page->content) }}</textarea>
                          @error('body')
                              <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
                    ...
                    <div class="form-group">
                      <button type="submit" class="btn btn-lg btn-primary">Update Page</button>
                    </div>
                  </div>
                </div>
            ...
            <!-- <div class="col-sm-5 pr-4">
              <div class="form-group">
                  ...
                  <img id='img-upload' src="{{ asset('images').'/'.$page->image}}" />
