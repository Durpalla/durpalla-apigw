...
<form method="post" action="{{ route('dashboard.coupon.update', $coupon->id)}}" role="form" enctype="multipart/form-data">
  @csrf
  @method('PUT')
  <div class="row">
      <!-- /.card-header -->
      <div class="col-md-7">
        <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Coupon name" value="{{ old('name', $coupon->name)}}" required="">
                @error('name')
              ...
              <div class="form-group">
                ...
                <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror" placeholder="Coupon code" value="{{ old('code', $coupon->code) }}" required="">
                @error('code')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
              ...
              <div class="form-group">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="number" min="0" id="discount_amount" name="discount_amount" class="form-control" value="{{ old('discount_amount', $coupon->discount_amount) }}" required>
                  <div class="input-group-append">
                    <div class="input-group-btn">
                      <select name="discount_type" class="form-control btn btn-default" value="{{ old('discount_type') }}" required>
                        <option value="flat" @if( $coupon->discount_type == 'flat') selected @endif>Fixed</option>
              ...
              <div class="form-group">
                ...
                <select name="type" id="applicableToType" class="form-control @error('type') is-invalid @enderror" value="{{ old('type') }}" required>
                  <option value="merchant" @if( $coupon->type == 'merchant') selected @endif>Merchant</option>
                  <option value="route" @if( $coupon->type == 'route') selected @endif>Route</option>
                  <option value="vehicle" @if( $coupon->type == 'vehicle') selected @endif>vehicle</option>
                  <option value="customer" @if( $coupon->type == 'customer') selected @endif>Special customers</option>
                  <option value="period" @if( $coupon->type == 'period') selected @endif>Periodical (Date range)</option>
                </select>
                @error('type')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
              ...
              <div class="form-group" id="otherThanPeriod" @if( $coupon->type == 'period' ) style="display: none;" @endif>
                <label>Item</label>
                <div class="select2-purple">
                  <select name="items[]" class="select2" id="items" multiple="multiple" data-placeholder="Select a State" data-dropdown-css-class="select2-purple" style="width: 100%;">
                    @if( $items )
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" name="offer_start" value="{{ old('offer_start', date('d/m/Y', strtotime( $coupon->offer_start ) ) ) }}" class="form-control datepicker @error('offer_start', date('d/m/Y') ) is-invalid @enderror" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask required>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" name="offer_end" value="{{ old('offer_end', date('d/m/Y', strtotime( $coupon->offer_end ) )) }}" class="form-control datepicker @error('offer_end', date('d/m/Y') ) is-invalid @enderror" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask required>
                    <div class="input-group-addon">
                        <span class="glyphicon glyphicon-th"></span>
                    </div>
                </div>
      ...
      <div class="col-5 mt-4">
        <div class="form-group clearfix">
                ...
                <div class="icheck-primary">
                  <input type="checkbox" class="cancel-item" id="checkboxPrimaryCabin" name="is_cabin" value="1"  @if($coupon->is_cabin) checked @endif>
                  <label for="checkboxPrimaryCabin">
                    Cabin
                  </label>
                </div>
                <div class="icheck-primary">
                  <input type="checkbox" class="cancel-item" id="checkboxPrimarySeat" name="is_seat" value="1" @if($coupon->is_seat) checked @endif>
                  <label for="checkboxPrimarySeat">
                    Seat
                  </label>
                </div>
                <div class="icheck-primary">
                  <input type="checkbox" class="cancel-item" id="checkboxPrimaryDeck" name="is_deck" value="1" @if($coupon->is_deck) checked @endif>
        ...
        <div class="form-group">
          ...
          <div class="icheck-primary">
            <input type="checkbox" class="cancel-item" id="checkboxPrimary" name="is_offer" value="1" @if( $coupon->is_offer ) checked @endif>
...
<script>
  $(function() {
    ...
    function initSelect2(val) {
      if( val == 'period' ) {
        $('#otherThanPeriod').hide();
      } else {
        $('#otherThanPeriod').show();
      }
