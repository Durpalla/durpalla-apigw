        ...
        <div class="row">
            <div class="col-12">
                <div class="card" style="background-color: none;">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('dashboard.report.vehicle.export') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>vehicle</label>
                                        <select class="form-control select2" name="vehicle_id"  id="filtervehicle" id="items" data-placeholder="Select vehicle" data-dropdown-css-class="select2-purple" style="width: 100%;" required>
                                            <option value="">Select vehicle</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label>Trip date</label>
                                        <input type="text" class="form-control datepicker" name="booking_date" id="booking_date" placeholder="search" value="{{old('booking_date', date('d/m/Y'))}}" required>
                                    </div>
                                    <div class="form-group">
