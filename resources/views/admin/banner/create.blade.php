...
@section('content')
    ...
    <section class="content content-overlap">
        <form method="post" action="{{ route('dashboard.banner.store')}}" role="form" enctype="multipart/form-data"
              id="couponForm2">
            <div class="row">
                <!-- /.card-header -->
                <div class="col-md-7">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="offer_start" value="{{ old('offer_start') }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="offer_end" value="{{ old('offer_end') }}"
