...
class AgentReferredMerchantController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'business_types.*' => 'bail|string|in:hotel,resort,homestay,tour,bus,train,air,launch,hotel_ops,bus_ops,tour_ops,tour_agency,resort_ops,homestay_ops,mixed,HOTEL,BUS_COMPANY,CONTRACT_MIDDLEMAN',
