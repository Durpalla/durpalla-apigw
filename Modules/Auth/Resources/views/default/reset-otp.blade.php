                    ...
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="p-2 mt-4 text-center">
                                ...
                                <p class="mb-5">Please enter the 6 digit code sent</p>

                                <form method="POST" action="{{ route('auth.verify-reset-otp') }}">
                                    @csrf
                                    ...
                                    <div class="mt-4">
                                        <button type="submit" id="otpSubmit" class="btn btn-success w-md"
                                                disabled>
                                            Confirm
                                        </button>

                                        <p class="mt-4">
                                            <a href="{{ route('auth.forgot-password') }}" class="text-muted mb-4">
                                                <i class="mdi mdi-lock me-1"></i> Back to forgot password?
                                            </a>
                                        </p>
                                    </div>
                                </form>
