...
use App\Http\Controllers\Api\v2\FrontApiController;
use App\Http\Controllers\Api\v2\ApiSupportController;
use App\Http\Controllers\Api\v2\AuthController;
use App\Http\Controllers\Api\v2\ApiCartController;
use App\Http\Controllers\Api\v2\ApiPaymentController;
use App\Http\Controllers\Api\v2\ApiOrderController;
use App\Http\Controllers\Api\v2\ApiBookingController;
use App\Http\Controllers\Api\v2\ApiCancellationController;
use App\Http\Controllers\Api\v2\MyApiController;
use App\Http\Controllers\Api\v2\QuickBookController;
use App\Http\Controllers\Api\v2\SupervisorController;
use App\Http\Controllers\Api\v2\TestController;
use App\Http\Controllers\Api\v2\NidVerificationController;
use App\Http\Controllers\Api\v2\ApiWithdrawalController;
use App\Http\Controllers\Api\v2\ApiWithdrawalMethodController;
